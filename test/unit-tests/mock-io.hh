...
public:
    ...
    MAKE_MOCK4(display, void(const std::shared_ptr<IEntity> center, std::shared_ptr<ILevel> level, const std::shared_ptr<ILightning> lightning,
        const std::unordered_map<uint32_t, std::shared_ptr<IAnimator>> &animators));
